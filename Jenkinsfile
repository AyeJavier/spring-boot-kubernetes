            ...
            steps{
        		...
        		script{
        		   ...
        		   env.TARGET = 'http://zero.webappsecurity.com/'
                    ...
                    sh '${DOCKER_EXEC} run --add-host="localhost:192.168.88.177" -v /Users/jcurguan/proyectos/propio/cursos/devsecops/20211015/jenkins_home/tools:/zap/wrk --rm -i owasp/zap2docker-stable zap-baseline.py -t "http://zero.webappsecurity.com/" -I -r zap_baseline_report.html -l PASS'	
